...
import { images, entityMemberRowHeight, snapPointVisibleRadius } from '../utils/Consts'
        ...
        <Circle 
          ...
          onDragEnd={e => {
            if (snapPoint.direction === "e-resize") {
              ...
              //TODO: fix when both sections are visible
              let ratio = props.state.membersSectionHeight / props.state.nameSectionHeight 
              let clone = {...props.state}
